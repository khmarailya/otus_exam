<?php
// HTTP
define('HTTP_SERVER', 'http://172.17.0.1:8080/admin/');
define('HTTP_CATALOG', 'http://172.17.0.1:8080/');
// HTTPS
define('HTTPS_SERVER', 'https://172.17.0.1/admin/');
define('HTTPS_CATALOG', 'https://172.17.0.1/');
// DIR
